...
public class Help {
    public static void displayHelp() throws IOException{
        System.out.println("===================");
        System.out.println("Welcome to Megordle, a text-based word game where you have to unscramble the given word. Lets break it down.\n");
        ...
        System.out.println("Megash: Megash is the cash system in Megordle. \nYour Megash is dependent on the number of points you earn. \nAt the end of a round, you will receive 10% of the amount of points you earned in Megash.\n");
